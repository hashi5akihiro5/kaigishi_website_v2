...
class CustomUser(AbstractBaseUser):
    ...
    username = models.CharField(verbose_name='ユーザー名', max_length=100, blank=True, null=True)
    last_name = models.CharField(verbose_name='名字', max_length=100, blank=True, null=True)
    first_name = models.CharField(verbose_name='名前', max_length=100, blank=True, null=True)
